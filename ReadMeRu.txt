...
http://veg.by/ru/projects/hostscmd/

Консольный редактор файла hosts.
...
v1.6.4 [2025/XX/XX]
 - Нельзя использовать имя "ics" для бэкапа на Windows (так как hosts.ics используется с другими целями).
...
v1.6.2 [2020/11/21]
 ...
 - Команда "list" использует аргумент "--all" вместо "all", и он может быть как до, так и после маски.
...
v1.5.0 [2011/11/17]
 - Поддержка запуска под Mono на Linux и MacOS
